...
const renderField = ({
  ...
  <div className="form-group">
    ...
    <div>A basic password requires at least 
      <ul className="mt-2">
        <li>atleast 1 lower case,</li><li>atleast 1 upper case,</li><li>atleast 1 numeric,</li><li>atleast 1 non-word and</li><li>no whitespace</li></ul></div>
...
let SignupForm = props => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <small className="text-danger">All fields are mandatory</small>
      <div className="row">
